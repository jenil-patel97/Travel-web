    ...
    <div className="w-full bg-gray-300 py-16">
      <div className="max-w-[1240px] mx-auto flex flex-col px-4">
        <div className="sm:flex text-center justify-center items-center">
          <h1 className="font-dance text-3xl md:mr-[50rem] cursor-default">
            Travel
          </h1>
      ...
      <p className="text-center text-sm font-dance cursor-default md:text-xl font-bold md:mt-12 mt-4">
        © 2022 Travel by Jenil. All Rights reserved.
      </p>
    </div>
  );
};
