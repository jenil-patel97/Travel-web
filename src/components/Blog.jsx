      ...
      <div className="md:grid grid-cols-2">
        ...
        <div>
          <p className="text-white font-dance text-center mt-[8rem] text-xl cursor-default">
            ...
            experience in Prague without crowd. That's what this insider's
            guide is all about with tourist traps to avoid, best things to do,
            favorite beers and pubs, neighborhoods to stay in, and where
            to eat in Prague .
          </p>
